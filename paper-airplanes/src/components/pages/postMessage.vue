<template>
  <div>
    ...
    <div id="plane" :class="{front}">  
        <textarea class="message">前端路上，一路有你。编辑你的正能量，快乐工作，努力生活~</textarea>
        <span class="send" @click="send"> 起飞 </span> <br/>
    </div>
    <div id="wind_container" :class="{beginning,hover,fly_away_first,fly_away}">
        <div id="left-wing">
            <div class="top_left curvable" :class={curved}> </div>
            <div class="bottom_left curvable" :class={curved}> </div>
            <div class="wing wing1"></div>
            <div class="wing wing2"></div>
        </div>
 
        <div id="right-wing">
            <div class="top_right curvable" :class={curved}> </div>
            <div class="bottom_right curvable" :class={curved}> </div>
            <div class="wing wing3"></div>
            <div class="wing wing4"></div>
        </div>
    </div>
    <div class="planes_mask" @click="hidens"></div>
</div>
  </div>
</template>
...
.wing1 {
  ...
  -webkit-transform: translateY(-38px) translateX(8px) rotateZ(22.62deg)
    skewY(-22.62deg);
  -moz-transform: translateY(-38px) translateX(8px) rotateZ(22.62deg)
    skewY(-22.62deg);
  -o-transform: translateY(-38px) translateX(8px) rotateZ(22.62deg)
    skewY(-22.62deg);
  -ms-transform: translateY(-38px) translateX(8px) rotateZ(22.62deg)
    skewY(-22.62deg);
...
#wind_container.hover.fly_away_first {
  -webkit-transform: translatex(-100px) translateZ(300px) rotateX(42deg)
    rotateY(-11deg) rotateZ(27deg);
  -moz-transform: translatex(-100px) translateZ(300px) rotateX(42deg)
    rotateY(-11deg) rotateZ(27deg);
  -o-transform: translatex(-100px) translateZ(300px) rotateX(42deg)
    rotateY(-11deg) rotateZ(27deg);
  -ms-transform: translatex(-100px) translateZ(300px) rotateX(42deg)
    rotateY(-11deg) rotateZ(27deg);
...
#wind_container.hover.fly_away_first.fly_away {
  -webkit-transform: translateX(600px) translateY(-400px) translateZ(-5000px)
    rotateX(66deg) rotateY(-12deg) rotateZ(36deg);
  -moz-transform: translateX(600px) translateY(-400px) translateZ(-5000px)
    rotateX(66deg) rotateY(-12deg) rotateZ(36deg);
  -o-transform: translateX(600px) translateY(-400px) translateZ(-5000px)
    rotateX(66deg) rotateY(-12deg) rotateZ(36deg);
  -ms-transform: translateX(600px) translateY(-400px) translateZ(-5000px)
    rotateX(66deg) rotateY(-12deg) rotateZ(36deg);
